...
if scrape_url:
    ...
    pric = st.session_state.scrapeIndex.query("Fetch the prices only of the following items, " +str(counted_list.keys()) + ", dont include anything else in the output, output should be in json list and values should e enclosed in double quotes  ")
